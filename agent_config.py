...
DQN_Vanilla_agent_config = {'agent_name': 'DQN', 'gamma' : 0.99, 'epsilon': 0.5, 'epsilon_decaying_rate': 0.9999, 'min_epsilon': 0.1, 'update_freq': 2, 'target_update_freq': 250,
                        'batch_size': 128, 'warm_up': 512, 'lr_critic': 0.0005, 'buffer_size': 100000, 'use_PER': True, 'use_ERE': False, 'reward_normalize' : False}
...
DQN_RND_agent_config = {'agent_name': 'DQN', 'gamma' : 0.99, 'epsilon': 0.9, 'epsilon_decaying_rate': 0.99, 'min_epsilon': 0.1, 'update_freq': 2, 'target_update_freq': 250,
                        'batch_size': 128, 'warm_up': 512, 'lr_critic': 0.0005, 'buffer_size': 100000, 'use_PER': True, 'use_ERE': False, 'reward_normalize' : False}
