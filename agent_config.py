...
DQN_RND_agent_config = {'agent_name': 'DQN', 'gamma' : 0.99, 'epsilon': 0.5, 'epsilon_decaying_rate': 0.99999, 'update_freq': 2, 'target_update_freq': 3,
                        'batch_size': 128, 'warm_up': 1024, 'lr_critic': 0.002, 'buffer_size': 2000000, 'use_PER': True, 'use_ERE': False, 'reward_normalize' : False}
DQN_RND_agent_config['extension'] = {'name': 'RND', 'use_DDQN':True, 'rnd_update_freq': 2, 'rnd_lr': 0.0005}
