...
# QR_DQN
QR_DQN_Vanilla_agent_config = {'agent_name': 'QR_DQN', 'gamma' : 0.99, 'tau': None, 'quantile_num': 32, 'epsilon': 0.99, 'epsilon_decaying_rate': 0.9999, 'min_epsilon': 0.1, 'update_freq': 3, 'target_update_freq': 3,
                        'batch_size': 128, 'warm_up': 1024, 'lr_critic': 0.002, 'buffer_size': 500000, 'use_PER': True, 'use_ERE': False, 'reward_normalize' : False}
