...
# DQN
DQN_Vanilla_agent_config = {'agent_name': 'DQN', 'gamma' : 0.99, 'epsilon': 0.9, 'epsilon_decaying_rate': 0.9999, 'min_epsilon': 0.2, 'update_freq': 1, 'target_update_freq': 10,
                        'batch_size': 128, 'warm_up': 512, 'lr_critic': 0.005, 'buffer_size': 100000, 'use_PER': True, 'use_ERE': False, 'reward_normalize' : False}
...
DQN_RND_agent_config = {'agent_name': 'DQN', 'gamma' : 0.99, 'epsilon': 0.9, 'epsilon_decaying_rate': 0.9999, 'min_epsilon': 0.05, 'update_freq': 1, 'target_update_freq': 2,
                        'batch_size': 128, 'warm_up': 512, 'lr_critic': 0.00025, 'buffer_size': 100000, 'use_PER': True, 'use_ERE': False, 'reward_normalize' : False}
