...
def env_agent_config(env_switch, agent_switch):
    # Env
    if env_switch == 1:
        env_config = {'env_name': 'LunarLander-v2', 'seed': 777, 'render': False, 'max_step': 500, 'max_episode': 2500}
    ...
    # DDQN
        ...
        from agent_config import DDQN_Vanilla_agent_config
        agent_config = DDQN_Vanilla_agent_config
    elif agent_switch == 6:
        from agent_config import DDQN_ICM_agent_config
        agent_config = DDQN_ICM_agent_config
    elif agent_switch == 7:
        from agent_config import DDQN_RND_agent_config
        agent_config = DDQN_RND_agent_config
    elif agent_switch == 8:
        from agent_config import DDQN_NGU_agent_config
        agent_config = DDQN_NGU_agent_config
