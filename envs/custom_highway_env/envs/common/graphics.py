...
from envs.custom_highway_env.envs.common.action import ActionType, DiscreteMetaAction, ContinuousAction
from envs.custom_highway_env.road.graphics import WorldSurface, RoadGraphics
from envs.custom_highway_env.vehicle.graphics import VehicleGraphics

if TYPE_CHECKING:
    from envs.custom_highway_env.envs import AbstractEnv
    from envs.custom_highway_env.envs.common.abstract import Action
