...
from envs.custom_highway_env.road.lane import LineType, StraightLane, SineLane
...
from envs.custom_highway_env.vehicle.objects import Obstacle
...
register(
    id='custom-merge-v0',
    entry_point='envs.custom_highway_env.envs:MergeEnv',
)
