...
from envs.custom_highway_env.road.lane import LineType, StraightLane, AbstractLane, lane_from_config
from envs.custom_highway_env.vehicle.objects import Landmark

if TYPE_CHECKING:
    from envs.custom_highway_env.vehicle import kinematics, objects
